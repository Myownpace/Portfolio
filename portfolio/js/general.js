window.onload = function(){
    ...
    var projectsTab
    var parsedProjects
    var projectsListView,projectsGridView,viewProject,selectedView,tabWrapper,viewProjectSmallScreen
            ...
            function adjust(){
                ...
                if(dim.w >= screenThreshold){
                    ...
                    if(!viewProjectSmallScreen){
                        viewProjectSmallScreen = new miniTab()
                    }
